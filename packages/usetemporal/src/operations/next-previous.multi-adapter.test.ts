...
withAllAdapters("next/previous", (adapter, _name, ctx) => {
  describe("next operation", () => {
    ...
    it("should get next month", () => {
      ...
      const nextMonth = next(ctx, month);
    ...
    it("should handle month boundaries", () => {
      ...
      const nextDay = next(ctx, lastDayOfMonth);
    ...
    it("should handle year boundaries", () => {
      ...
      const january = next(ctx, december);
    ...
    it("should handle day boundary for hours", () => {
      ...
      const nextHour = next(ctx, lastHour);
  ...
  describe("previous operation", () => {
    it("should get previous day", () => {
      const day = period(adapter, new Date(2024, 0, 15), "day");
      const prevDay = previous(ctx, day);
    ...
    it("should get previous month", () => {
      ...
      const prevMonth = previous(ctx, month);
    ...
    it("should get previous year", () => {
      const year = period(adapter, new Date(2024, 5, 15), "year");
      const prevYear = previous(ctx, year);
    ...
    it("should handle month boundaries", () => {
      ...
      const prevDay = previous(ctx, firstDayOfMonth);
    ...
    it("should handle year boundaries", () => {
      ...
      const december = previous(ctx, january);
    ...
    it("should get previous minute", () => {
      ...
      const prevMinute = previous(ctx, minute);
    ...
    it("should handle hour boundary for minutes", () => {
      ...
      const prevMinute = previous(ctx, firstMinute);
  ...
  describe("next/previous consistency", () => {
    it("should be reversible operations", () => {
      ...
      units.forEach((unit) => {
        ...
        const nextPeriod = next(ctx, p);
        const backToPeriod = previous(ctx, nextPeriod);
    ...
    it("should handle week navigation correctly", () => {
      ...
      const nextWeek = next(ctx, week);
      const prevWeek = previous(ctx, week);
