...
withAllAdapters("next/previous", (adapter) => {
  ...
  describe("next operation", () => {
    ...
    it("should handle month boundaries", () => {
      const lastDayOfMonth = period(temporal, new Date(2024, 0, 31), "day");
    ...
    it("should handle day boundary for hours", () => {
      const lastHour = period(temporal, new Date(2024, 0, 15, 23), "hour");
  ...
  describe("previous operation", () => {
    ...
    it("should get previous month", () => {
      const month = period(temporal, new Date(2024, 1, 15), "month");
    ...
    it("should handle month boundaries", () => {
      const firstDayOfMonth = period(temporal, new Date(2024, 1, 1), "day");
    ...
    it("should handle hour boundary for minutes", () => {
      const firstMinute = period(temporal, new Date(2024, 0, 15, 14, 0), "minute");
  ...
  describe("next/previous consistency", () => {
    it("should be reversible operations", () => {
      ...
      units.forEach(unit => {
        ...
        const nextPeriod = next(temporal, p);
