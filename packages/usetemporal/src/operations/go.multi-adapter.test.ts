...
withAllAdapters("go", (adapter) => {
  ...
  describe("navigation operations", () => {
    it("should navigate forward by positive amounts", () => {
      ...
      const day = period(temporal, startDate, "day");
    ...
    it("should navigate backward by negative amounts", () => {
      ...
      const month = period(temporal, startDate, "month");
    ...
    it("should navigate weeks correctly", () => {
      const week = period(temporal, new Date(2024, 0, 10), "week");
    ...
    it("should navigate hours correctly", () => {
      const hour = period(temporal, new Date(2024, 0, 15, 10), "hour");
    ...
    it("should handle month boundaries correctly", () => {
      // Start on January 31
      const day = period(temporal, new Date(2024, 0, 31), "day");
      ...
      const month = period(temporal, new Date(2024, 0, 31), "month");
    ...
    it("should handle daylight saving time transitions", () => {
      ...
      const beforeDST = period(temporal, new Date(2024, 2, 9), "day"); // March 9
    ...
    it("should preserve period type", () => {
      ...
      units.forEach(unit => {
        ...
        const navigated = go(temporal, p, 1);
        expect(navigated.type).toBe(unit);
      });
    });

    it("should handle large offsets", () => {
      const day = period(temporal, new Date(2024, 0, 1), "day");
