...
```bash
npm pack
# Creates @minuta-2.0.0.tgz

# Test in separate directory
mkdir /tmp/test-package
cd /tmp/test-package
npm init -y
npm install /path/to/pickle/packages/usetemporal/@minuta-2.0.0.tgz

# Test imports
node --input-type=module -e "import { period } from 'minuta/operations'; console.log('✓ operations')"
node --input-type=module -e "import { createStableMonth } from 'minuta/calendar'; console.log('✓ calendar')"
node --input-type=module -e "import { createNativeAdapter } from 'minuta/native'; console.log('✓ native')"
```
...
import { period } from 'minuta/operations';
import { createStableMonth } from 'minuta/calendar';
import type { Period, Adapter } from 'minuta/types';
...
```bash
git grep "from \"minuta" --include="*.ts" --include="*.tsx"
...
- [ ] **Create import guide** (save for Story 007.05)
  - Level 1: `import { period } from 'minuta/operations'`
  - Level 2: `import { createTemporal } from 'minuta'`
  - Level 3: `import { usePeriod } from 'minuta'`
