...
6. No wrong package names: `minuta`, `/adapter-*`
...
- [ ] **Run comprehensive grep audit**
  ...
  echo "=== Checking for minuta ==="
  grep -r "minuta" vitepress/ --exclude-dir=node_modules | wc -l

  echo "=== Checking for /adapter- ==="
  grep -r "/adapter-" vitepress/ --exclude-dir=node_modules | wc -l
  ```
...
- [ ] **Setup TypeScript project**
  ...
  npm init -y
  npm install typescript minuta @types/node
  ```
...
- [ ] **Create import validation script**
  ...
  grep -r "from 'minuta'" vitepress/ --exclude-dir=node_modules
