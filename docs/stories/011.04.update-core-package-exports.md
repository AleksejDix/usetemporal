...
- `packages/usetemporal/src/index.ts` - Already contains only pure exports
- `packages/usetemporal/package.json` - Already has correct exports map and empty dependencies
