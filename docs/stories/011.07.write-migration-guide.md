...
6. Document new package structure (minuta-vue, -react)
...
- [ ] Document new architecture (AC: 6)
  ...
  - [ ] Document minuta (core)
  - [ ] Document minuta-vue
  - [ ] Document minuta-react
...
- [ ] Add reference links (AC: 9)
  - [ ] Link to minuta README
  - [ ] Link to minuta-vue README
  - [ ] Link to minuta-react README
  - [ ] Link to examples
...
- [ ] Update package.json dependencies
  - [ ] Keep minuta
  - [ ] Add minuta-vue OR minuta-react
- [ ] Update import statements
  - [ ] Change createTemporal → Minuta
  - [ ] Update import path to framework package
- [ ] Update function calls
  - [ ] Rename createTemporal() to useMinuta()
...
find src -name "*.vue" -o -name "*.ts" -o -name "*.tsx" | xargs sed -i '' \
  's/@allystudio\/minuta/@allystudio\/minuta-vue/g'

find src -name "*.vue" -o -name "*.ts" -o -name "*.tsx" | xargs sed -i '' \
  's/createTemporal/Minuta/g'
