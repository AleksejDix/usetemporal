...
# Measure core
gzip -c packages/minuta/dist/index.js | wc -c

# Measure Vue
gzip -c packages/minuta-vue/dist/index.js | wc -c

# Measure React
gzip -c packages/minuta-react/dist/index.js | wc -c
```
...
```json
{
  "bundlesize": [
    {
      "path": "packages/minuta/dist/index.js",
      "maxSize": "8 KB",
      "compression": "gzip"
    },
    {
      "path": "packages/minuta-vue/dist/index.js",
      "maxSize": "22 KB",
      "compression": "gzip"
    },
    {
      "path": "packages/minuta-react/dist/index.js",
      "maxSize": "20 KB",
      "compression": "gzip"
    }
  ]
...
CORE_SIZE=$(gzip -c packages/minuta/dist/index.js | wc -c)
...
VUE_SIZE=$(gzip -c packages/minuta-vue/dist/index.js | wc -c)
...
REACT_SIZE=$(gzip -c packages/minuta-react/dist/index.js | wc -c)
