...
## Story
**As a** developer,
**I want** to set up the minuta/calendar package infrastructure,
...
- [x] Configure package.json (AC: 2, 6)
  - [x] Set package name as `minuta/calendar`
  - [x] Add peer dependency on `minuta`
...
- Successfully created minuta/calendar package structure following monorepo conventions
...
2. ✅ Package.json properly configured with dependencies and scripts
3. ✅ TypeScript config extends shared tsconfig
4. ✅ Core integration via peer dependency
5. ✅ Unit registry integration tested with testWeek unit
6. ✅ ESM exports properly configured
7. ✅ Vitest test infrastructure operational
8. ✅ Package builds and links successfully
