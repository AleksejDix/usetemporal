...
- [x] Implementation Tasks (AC: 1-7)
  - [x] Create stableYear.ts in packages/minuta/src/calendar/
...
### Testing Standards
- Test file location: packages/minuta/src/calendar/__tests__/stableYear.test.ts
...
### Related Files
- packages/minuta/src/calendar/stableMonth.ts (reference implementation)
- packages/minuta/src/calendar/index.ts (export location)
- packages/minuta/src/unit-registry.ts (unit registration)
...
### File List
- packages/minuta/src/calendar/stableYear.ts (created)
- packages/minuta/src/calendar/__tests__/stableYear.test.ts (created)
- packages/minuta/src/calendar/index.ts (modified - added stableYear export)
- packages/minuta/src/index.ts (modified - exported calendar helpers)
- packages/minuta/src/calendar/__tests__/integration.test.ts (modified - added stableYear tests)
