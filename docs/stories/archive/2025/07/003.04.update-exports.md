...
- Added to the meta-package (/minuta)
...
- [ ] Meta-package exports updated in `packages/minuta/src/index.ts`
- [ ] Package.json exports field includes UNITS
- [ ] Import works from all paths: 'minuta', '/usetemporal'
...
export { UNITS } from 'minuta';
// Re-export everything else
export * from 'minuta';
export { createNativeAdapter } from 'minuta/native';

// Verify imports work
import { UNITS } from 'minuta';
import { UNITS as MetaUnits } from 'minuta';
...
2. **Meta-Package Integration**: ✅ COMPLETE
   - Uses `export * from "minuta"` pattern (line 4)
