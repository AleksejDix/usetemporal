...
**I want** a Minuta adapter for Moment.js,  
**so that** I can migrate to Minuta while keeping my existing Moment.js code.
...
- This adapter helps transition to Minuta first
