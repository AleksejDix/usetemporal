...
### File List
- Modified: /packages/minuta/src/operations/createPeriod.ts
- Deleted: /packages/minuta/src/operations/toPeriod.ts
- Deleted: /packages/minuta/src/operations/toPeriod.multi-adapter.test.ts
...
- Modified: /packages/minuta/src/operations/regression.test.ts
- Modified: /packages/minuta/src/operations/*.multi-adapter.test.ts (all files)
