...
function period(adapter: Adapter, custom: {start: Date, end: Date}): Period;

// Implementation
function period(adapter: Adapter, dateOrCustom: Date | {start: Date, end: Date}, unit?: Unit): Period {
...
### File List
- Modified: packages/minuta/src/operations/period.ts
- Deleted: packages/minuta/src/operations/createCustomPeriod.ts
- Deleted: packages/minuta/src/operations/createCustomPeriod.test.ts
- Created: packages/minuta/src/operations/period.custom.test.ts
- Modified: packages/minuta/src/operations/index.ts
- Modified: packages/minuta/src/index.ts
- Modified: packages/minuta/src/exports.test.ts
- Modified: packages/minuta/src/composables/usePeriods.ts
- Modified: packages/minuta/src/operations/merge.ts
- Modified: packages/minuta/src/operations/next.ts
- Modified: packages/minuta/src/operations/previous.ts
- Modified: packages/minuta/src/operations/go.ts
