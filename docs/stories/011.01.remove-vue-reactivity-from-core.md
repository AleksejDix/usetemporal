...
**As a** developer using Minuta in any JavaScript framework,
...
1. Remove `@vue/reactivity` dependency from `packages/minuta/package.json`
...
**Key Files to Modify:**
- `packages/minuta/package.json` - Remove dependency
- `packages/minuta/src/index.ts` - Remove exports
- `packages/minuta/src/createTemporal.ts` - Remove or relocate
- `packages/minuta/src/composables/usePeriod.ts` - Remove or relocate
- `packages/minuta/src/types.ts` - Remove Ref types
...
The removed code will be reimplemented in `minuta-vue`:
- `createTemporal` → `Minuta` (Vue composable)
...
**Modified:**
- packages/minuta/package.json (removed dependency, updated keywords, removed exports)
- packages/minuta/src/types.ts (removed Ref import, Temporal interface, DateOrRef type)
- packages/minuta/src/index.ts (removed createTemporal, builder, usePeriod exports)
- packages/minuta/src/__tests__/integration/exports.test.ts (removed tests for removed exports)

**Renamed (.removed):**
- packages/minuta/src/createTemporal.ts
- packages/minuta/src/createTemporal.test.ts
- packages/minuta/src/builder.ts
- packages/minuta/src/builder.test.ts
- packages/minuta/src/composables/usePeriods.ts
- packages/minuta/src/composables/reactivity.test.ts
...
- Files correctly organized in `packages/minuta/src/`
...
- Reactive files saved as `.removed` for Story 011.03 (minuta-vue)
