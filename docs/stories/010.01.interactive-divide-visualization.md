...
## Story
**As a** visitor to the Minuta documentation site,  
...
- Touch points: Landing page hero section, Minuta core library
...
8. Component uses actual Minuta divide() operations for data
...
13. Visual design matches VitePress theme and Minuta branding
