...
- Structural directives (e.g., `*ustWeek`, `*ustDay`) for iterating divided
  periods directly in templates.
- Utility functions for hooking the builder into control-flow blocks or
  standalone components.

Keep an eye on the roadmap—APIs will mirror other frameworks so business logic
stays portable.
